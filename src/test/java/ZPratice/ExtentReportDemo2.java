...
public class ExtentReportDemo2 
{
	...
	public void setup()
	{
	    ExtentHtmlReporter reporter=new ExtentHtmlReporter("learn_automation2666.html");
		
	    extent = new ExtentReports();
	    
	    extent.attachReporter(reporter);
	    
	    logger=extent.createTest("LoginTest","This is the test to validate gogle functionality");
	}
